...
export const caseStudyDetails: DetailMap = {
  "amlaw-ip-landmark-win": {
    ...
    facts: [
      { label: "Judgment secured", value: "$180M" },
      { label: "Time to full precedent map", value: "72 hours" },
      { label: "Jurisdictions unified", value: "3" },
      { label: "Sector", value: "AmLaw 100 Firm" },
      { label: "Engagement length", value: "9 days" },
      { label: "Team deployed", value: "6 analysts, 2 doctrinal leads" },
      { label: "Data analyzed", value: "2.4M opinions and citations" },
  ...
  "fortune500-acquisition-derisk": {
    ...
    subtitle: "A Fortune 500 enterprise uncovered $310M in hidden exposure across 14 countries before signing.",
    meta: "Fortune 500 Enterprise",
    lead: "A Fortune 500 industrials enterprise was days from committing to a $2B cross-border acquisition when it engaged Bennet Legal Research Group to stress-test the target's true risk profile. Conventional diligence had cleared the deal, but the acquirer's leadership suspected that regulatory and litigation exposure buried across the target's fourteen operating jurisdictions had not been fully surfaced. In five days, Bennet's diligence-intelligence pipeline mapped the target's exposure across all fourteen countries and identified $310M in previously undisclosed risk, giving the board the leverage and the facts to reprice and restructure the transaction before signing.",
    sections: [
      {
        heading: "The challenge",
        body: [
    ...
    facts: [
      { label: "Countries analyzed", value: "14" },
      { label: "Exposure identified", value: "$310M" },
      { label: "Full diligence turnaround", value: "5 days" },
      { label: "Sector", value: "Fortune 500 Enterprise" },
      { label: "Engagement length", value: "5 days" },
      { label: "Team deployed", value: "11 analysts across 6 regional desks" },
      { label: "Data analyzed", value: "Filings and dockets across 14 jurisdictions" },
  ...
  "regulatory-forecast-trading-desk": {
    ...
    facts: [
      { label: "Early warning", value: "4 months" },
      { label: "Forecast confidence", value: "94%" },
      { label: "Compliance penalties", value: "$0" },
      { label: "Sector", value: "Global Investment Bank" },
      { label: "Engagement length", value: "Ongoing standing program" },
      { label: "Team deployed", value: "5 analysts, 2 quantitative modelers" },
      { label: "Data analyzed", value: "Multi-year regulatory signal corpus" },
  ...
  "biotech-patent-moat": {
    ...
    facts: [
      { label: "Patents analyzed", value: "1.2M" },
      { label: "White-space filings", value: "17" },
      { label: "Time to strategy", value: "6 weeks" },
      { label: "Sector", value: "Biotech Scale-Up" },
      { label: "Engagement length", value: "6 weeks" },
      { label: "Team deployed", value: "7 analysts, 2 technical domain leads" },
      { label: "Data analyzed", value: "1.2M patents across field and adjacencies" },
